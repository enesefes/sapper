...
const Oyuncular = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<p>burası oyuncular</p>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-1dbd5up"}"><ul class="${"svelte-1dbd5up"}"><li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-1dbd5up"}">home</a></li>
		...
		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "oyuncular" ? "page" : undefined, 0)} href="${"oyuncular"}" class="${"svelte-1dbd5up"}">oyuncular</a></li>
...
const manifest = {
	...
	pages: [
		...
		{
			// oyuncular/index.svelte
			pattern: /^\/oyuncular\/?$/,
			parts: [
				{ name: "oyuncular", file: "oyuncular/index.svelte", component: Oyuncular }
			]
		},
